...
const Layananedit = ({ navigation, route }) => {
  ...
  const [id_laundri, setid_laundri] = useState(route.params.id_laundri)
  const [nama_kategori, setnama_kategori] = useState(route.params.nama_kategori)
  const [nama_layanan, setnama_layanan] = useState(route.params.nama_layanan)
  const [gambar_layanan, setgambar_layanan] = useState('')
  const [satuan_harga, setsatuan_harga] = useState(route.params.satuan_harga)
  const [harga_layanan, setharga_layanan] = useState(route.params.harga_layanan)
  const [deskripsi_layanan, setdeskripsi_layanan] = useState(route.params.deskripsi_layanan)
  // Setup inputan focus
  ...
  async function simpanLayanan(){
      ...
      await fetch(`${DATA_API}/layanan/update`, {
          method: 'POST',
          headers: {
          ...
          >
              <View className="flex flex-row items-center">
                  <View className="flex flex-row items-center">
                      ...
                      <Text className="mx-4 text-xl font-medium text-white">EDIT LAYANAN</Text>
                  </View>
          ...
          <ScrollView className="p-6 mt-24">
              <View className="mb-3">
                  ...
                  <TextInput
                      ...
                      placeholder={`${route.params.nama_layanan}`}
              ...
              <View className="mb-3">
                  ...
                  <TextInput
                      ...
                      placeholder={`${route.params.nama_kategori}`}
                      placeholderTextColor={{
                          color: 'grey'
                      }}
              ...
              <View className="mb-3">
                  ...
                  <TouchableOpacity onPress={() => setModalVisible(true)} className={`rounded-md bg-slate-200 text-base font-medium text-slate-500 px-6 py-5 ${gambar_layananfocus ? ('border-2 border-purple-600') : ('border-2 border-slate-200')}`}>
                      <Text className="text-base font-medium text-slate-400">{gambar_layanan == '' ? (route.params.gambar_layanan) : gambar_layanan}</Text>
                  </TouchableOpacity>
              </View>
              <View className="mb-3">
                  ...
                  <TextInput
                      ...
                      placeholder={`${route.params.harga_layanan}`}
                      placeholderTextColor={{
                          color: 'grey'
                      }}
              ...
              <View className="mb-3">
                  ...
                  <TextInput
                      ...
                      placeholder={`${route.params.satuan_harga}`}
                      placeholderTextColor={{
                          color: 'grey'
                      }}
              ...
              <View className="mb-3">
                  ...
                  <TextInput
                      ...
                      placeholder={`${route.params.deskripsi_layanan}`}
                      placeholderTextColor={{
                          color: 'grey'
                      }}
