...
<style>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">FORM TAMBAH DATA ORDERAN</h4>
    ...
    <form action="{{ url('admin/orderan/store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
        @csrf
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="id_laundri" id="pilihLaundri" class="form-control  @error('id_laundri') is-invalid @enderror">
                                    ...
                                    @foreach ($laundri as $l)
                                        <option value="{{ $l->id }}" data-id="{{ $l->id }}">{{ $l->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
