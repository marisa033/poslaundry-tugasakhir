    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">DATA LAUNDRY</h4>

                <div class="page-title-right">
                    <a href="{{ url('admin/laundri/create') }}" class="btn btn-success">TAMBAH DATA</a>
                </div>
                                ...
                                @foreach ($list as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <img src="{{ url('public/'.$item->gambar) }}" alt="user" class="avatar-xs rounded-circle" />
                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group">
                                                    <a href="{{ url('admin/laundri/show', $item->id) }}" class="btn btn-warning">
                                                        <i class="mdi mdi-eye"></i>
                                                    </a>
                                                    <a href="{{ url('admin/laundri/edit', $item->id) }}" class="btn btn-primary">
                                    ...
                                    <div class="modal fade" id="hapus{{ $item->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form action="{{ url('admin/laundri/destroy', $item->id) }}" method="POST">
                                                @csrf
