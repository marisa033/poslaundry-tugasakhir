...
@endforeach
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">EDIT DATA PELANGGAN</h4>
    ...
    <form action="{{ url('admin/pelanggan/update', encrypt($pelanggan->id)) }}" method="POST" enctype="multipart/form-data" class="mb-5">
        @csrf
        <input type="hidden" id="lat" name="lat" value="{{ $pelanggan->lat }}" class="form-control">
        <input type="hidden" id="lng" name="lng" value="{{ $pelanggan->lng }}" class="form-control">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                         ...
                         <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control  @error('nama') is-invalid @enderror" name="nama" value="{{ $pelanggan->nama }}" placeholder="Nama pelanggan ..." autocomplete="off">
                                @error('nama')    
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control  @error('tlp') is-invalid @enderror" name="tlp" value="{{ $pelanggan->tlp }}" placeholder="Telepon pelanggan ..." autocomplete="off">
                                @error('tlp')    
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ $pelanggan->email }}" placeholder="email pelanggan ..." autocomplete="off">
                                @error('email')    
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div style="position: relative">
                                    ...
                                    <input type="text" class="form-control " name="alamat" value="{{ $pelanggan->alamat }}" id="alamat" placeholder="Alamat pelanggan ..." autocomplete="off" readonly>
                                    @error('alamat')    
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="lats" value="{{ $pelanggan->lat }}" class="form-control" readonly placeholder="Latitude ...">
                            
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="nama">Longitide</label>
                            <input type="text" id="lngs" value="{{ $pelanggan->lng }}" class="form-control" readonly placeholder="Longitude ...">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="nama">Alamat</label>
                            <input type="text" id="alamats" value="{{ $pelanggan->alamat }}" class="form-control" placeholder="Cari alamat ...">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
    ...
    <script>
            ...
            var latitude = {{ $pelanggan->lat }};
			var longitude = {{ $pelanggan->lng }};
