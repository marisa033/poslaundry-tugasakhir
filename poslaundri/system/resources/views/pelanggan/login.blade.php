                        ...
                        <div class="card-body p-4">
                            <div class="p-2">
                                ...
                                @foreach (['success', 'danger', 'warning', 'info'] as $status)
                                    ...
                                    @endif
                                @endforeach
                                <form action="{{ url('pelanggan/aksiLogin') }}" method="POST" class="mb-5">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                             <div style="margin-top: 24px; display: flex;align-items:center;justify-content: center;">
                                                  <p style="display:block;padding: 0;margin: 0">Belum punya akun?!, </p>
                                                  <a href="{{ url('pelanggan/daftar') }}" class="btn btn-link" style="font-weight:500">Silahkan daftar disini !  </a>
                                             </div>
                                        </div>
                                   </div>
                                </form>
